...
import com.ivelox.core.modules.finance.domain.model.Upcoming;
...
public class FinanceNotifier {
    ...
    private final NotificationSenderPort telegram;

    public FinanceNotifier(FinanceRepositoryPort repo, NotificationSenderPort telegram) {
        this.repo = repo;
        this.telegram = telegram;
    }

    public void afterPost(FinanceMath.MonthSlice slice, String currency, String kind, Settings settings) {
    ...
    public void sendDigest(Settings settings, FinanceMath.MonthSlice slice,
                           String currency, List<Upcoming> upcoming) {
        ...
        if (!upcoming.isEmpty()) {
            ...
            sb.append(u.name()).append(' ').append(format(u.amountMinor(), currency))
