...
public class FinanceDigestJob {
    ...
    public FinanceDigestJob(FinanceRepositoryPort repo, FinanceDuePoster duePoster, FinanceNotifier notifier) {
        this.repo = repo;
    ...
    public void sendDigest() {
        ...
        var upcoming = repo.fixed(OWNER).stream()
                ...
                .map(f -> {
                    ...
                    return new Upcoming("fixed", f.name(), due, f.amountMinor(), currency);
                })
