...
public class HealthGoalsRepository {
    ...
    private static final RowMapper<HealthModels.HealthGoal> MAPPER = (rs, i) -> new HealthModels.HealthGoal(
            ...
            rs.getString("sex"),
            (Integer) rs.getObject("age_years"),
            rs.getString("activity_level"),
            (Double) rs.getObject("weight_change_pct"),
            (Integer) rs.getObject("weeks"),
            (Double) rs.getObject("target_weight_kg"),
            (Integer) rs.getObject("daily_kcal_target"),
            (Integer) rs.getObject("daily_burn_target"),
