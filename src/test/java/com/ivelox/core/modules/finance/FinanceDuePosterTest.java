...
import com.ivelox.core.modules.finance.application.service.FinanceDuePoster;
...
class FinanceDuePosterTest {
    ...
    void eurMonthlyIncomePostsInEur() {
        var income = repo.insertIncome(new Income(
    ...
    void catchUpPostsDuesMissedDuringDowntime() {
        repo.insertFixed(new FixedExpense(
    ...
    void loanPaymentSkippedOnceFullyRepaid() {
        var loan = repo.insertLoan(new Loan(
