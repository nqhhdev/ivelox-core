...
import com.ivelox.core.modules.finance.application.service.FinanceNotifier;
...
class FinanceNotifyTest {
    ...
    @Autowired
    private FinanceRepositoryPort repo;

    @Autowired
    private FinanceNotifier notifier;

    @Autowired
    private NotificationSenderPort telegram;
    ...
    void digestSkippedWhenDisabled() {
        var settings = new Settings("owner", "VND", 21, false, true, true);
